            ...
            <section
                ...
                <div class="max-w-2xl mx-auto px-4">
                    ...
                    <form class="mb-6" @submit.prevent v-if="this.isLogedIn == true && this.user != ''">
                        <div class="flex items-center w-60 justify-between px-4 py-1  dark:bg-[#1e1e1e] rounded-lg border border-gray-700 mb-2" v-if="this.replyId != null">
                            <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold">
                                <img class="mr-2 w-6 h-6 rounded-full"
                                    :src="this.userDataReply.picture"
                                    alt="Michael Gough" />
                            </p>
                            <p class="text-sm text-gray-600 dark:text-gray-400 inline">
                                {{ this.userDataReply.name }}
                            </p>
                            <IconX class="mr-1.5 text-black dark:bg-white  rounded-2xl ml-5 cursor-pointer" :size="19" @click="cancel"></IconX>
                        </div>
                        ...
                        <div
                            ...
                            <textarea id="comment" rows="6" :value="comment" @input="comment = $event.target.value"
                    ...
                    <div @click="login" prompt auto-login class="py-2 w-full bg-[#1e1e1e]  dark:bg-white text-center cursor-pointer mb-3 rounded-xl" v-else>
                    ...
                    <article class="p-6 text-base bg-white rounded-lg dark:bg-[#333]" v-for="it in this.discussion">
                        ...
                        <div class="flex items-center mt-4 space-x-4">
                            ...
                            <article class="p-6 mb-3 ml-6 lg:ml-12 text-base bg-white rounded-lg dark:bg-[#333] elem" v-for="mes in it.reply_message">
                                <footer class="flex justify-between items-center mb-2">
                                    <div class="flex items-center">
                                        <p
                                            class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold">
